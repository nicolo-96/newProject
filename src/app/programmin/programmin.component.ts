...
@Component({
  selector: 'app-programmin',
  templateUrl: './programmin.component.html',
  styleUrls: ['./programmin.component.scss']
})
export class ProgramminComponent implements OnInit {

  private URL = '../assets/film.json';

  header: string = 'CineMille';
  subtitle: string = 'Programmazione';
